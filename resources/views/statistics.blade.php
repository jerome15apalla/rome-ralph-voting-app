...
@section('content')
    <div class="container">
        <p class='display-5 mb-0 mt-3 text-light'>Election Statistics</p>
        <p class='text-light'>Exclusive to COMELEC Officials</p>
        <div class="row">
            <div class="col-12 col-lg-6 mb-3">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Registered Voters.</p>
                    <br>
                </div>
                </div>
            </div>
            <div class="col-12 col-lg-6 mb-3">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title pt-2">75% of voters</h5>
